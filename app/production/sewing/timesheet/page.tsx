...
export default function SewingTimesheetPage() {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", `Табель_Пошива_${monthName}.csv`);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h1 className="text-xl md:text-3xl font-bold flex items-center gap-2">
            ...
            <span className="hidden sm:inline">Табель Пошива</span><span className="sm:hidden">Табель</span>
          </h1>
