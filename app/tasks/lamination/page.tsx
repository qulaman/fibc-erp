...
import { ArrowLeft, Calendar, Users, AlertCircle, MessageSquare, TrendingUp, History, Flag, Layers } from "lucide-react";
  ...
  const logChange = async (taskId: string, fieldName: string, oldValue: any, newValue: any) => {
    ...
    try {
      await supabase
        ...
        .insert([{
          task_id: taskId,
          changed_by: user?.email || 'Цех Ламинации',
    ...
    <div className="page-container">
      ...
      <div className="page-header">
        <div className="flex items-center gap-4">
          <Link href="/production/lamination">
          ...
          <div>
            <h1 className="h1-bold">
              <div className="bg-cyan-600 p-2 rounded-lg inline-block">
                <Layers size={24} className="text-white" />
              </div>
              {' '}Задачи цеха Ткачества
            </h1>
            <p className="page-description">Задачи от руководства для цеха ламинации</p>
          </div>
        </div>
      </div>
            ...
            return (
              <div
                ...
                className={`bg-zinc-900 border rounded-xl p-6 transition-all ${
                  isEditing ? 'border-cyan-500' : 'border-zinc-800 hover:border-zinc-700'
                }`}
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="p-2 text-cyan-400 hover:text-blue-300 hover:bg-cyan-950 rounded transition-colors ml-4"
                ...
                {!isEditing ? (
                  <>
                    ...
                    <Button
                      ...
                      className="bg-cyan-600 hover:bg-blue-700 text-white font-bold gap-2"
                    >
                      <TrendingUp size={16} />
                      Обновить статус
                    </Button>
                  ...
                  <div className="space-y-4 bg-zinc-800/30 border border-cyan-500/30 rounded-lg p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                        >
                          {statuses.map(status => (
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="bg-cyan-600 hover:bg-blue-700 text-white font-bold"
                      >
                        Сохранить
                      </Button>
                      <Button
                    ...
                    {taskHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {taskHistory.map((change) => (
                          <div key={change.id} className="text-sm border-l-2 border-cyan-500 pl-3 py-1">
                            ...
                            <p className="text-white">
                              <span className="text-cyan-400">{getFieldNameRu(change.field_name)}</span>:{' '}
