  ...
  const logChange = async (taskId: string, fieldName: string, oldValue: any, newValue: any) => {
    ...
    try {
      await supabase
        ...
        .insert([{
          task_id: taskId,
          changed_by: user?.email || 'Цех Строп',
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="h1-bold">
              <div className="bg-orange-600 p-2 rounded-lg inline-block">
                <Scissors size={24} className="text-white" />
              </div>
              {' '}Задачи цеха Ткачества
            </h1>
            <p className="page-description">Задачи от руководства для цеха строп</p>
          </div>
        </div>
      </div>
            ...
            return (
              <div
                ...
                className={`bg-zinc-900 border rounded-xl p-6 transition-all ${
                  isEditing ? 'border-orange-500' : 'border-zinc-800 hover:border-zinc-700'
                }`}
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="p-2 text-orange-400 hover:text-blue-300 hover:bg-orange-950 rounded transition-colors ml-4"
                ...
                {!isEditing ? (
                  <>
                    ...
                    <Button
                      ...
                      className="bg-orange-600 hover:bg-blue-700 text-white font-bold gap-2"
                    >
                      <TrendingUp size={16} />
                      Обновить статус
                    </Button>
                  ...
                  <div className="space-y-4 bg-zinc-800/30 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="bg-orange-600 hover:bg-blue-700 text-white font-bold"
                      >
                        Сохранить
                      </Button>
                      <Button
                    ...
                    {taskHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {taskHistory.map((change) => (
                          <div key={change.id} className="text-sm border-l-2 border-orange-500 pl-3 py-1">
                            ...
                            <p className="text-white">
                              <span className="text-orange-400">{getFieldNameRu(change.field_name)}</span>:{' '}
