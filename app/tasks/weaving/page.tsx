  ...
  const logChange = async (taskId: string, fieldName: string, oldValue: any, newValue: any) => {
    ...
    try {
      await supabase
        ...
        .insert([{
          task_id: taskId,
          changed_by: user?.email || 'Цех Ткачества',
      ...
      <div className="page-header">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="page-description">Задачи от руководства для цеха ткачества</p>
          </div>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                {!isEditing ? (
                  ...
                  <div className="space-y-4 bg-zinc-800/30 border border-blue-500/30 rounded-lg p-4">
                    ...
                    {taskHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {taskHistory.map((change) => (
                          <div key={change.id} className="text-sm border-l-2 border-blue-500 pl-3 py-1">
                            ...
                            <p className="text-white">
                              <span className="text-blue-400">{getFieldNameRu(change.field_name)}</span>:{' '}
