...
import { ArrowLeft, Calendar, Users, AlertCircle, MessageSquare, TrendingUp, History, Flag, Building2 } from "lucide-react";
...
export default function OfficeTasksPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Новая':
        return 'bg-blue-500/10 text-slate-400 border-slate-500/50';
      case 'В работе':
            ...
            return (
              <div
                ...
                className={`bg-zinc-900 border rounded-xl p-6 transition-all ${
                  isEditing ? 'border-slate-500' : 'border-zinc-800 hover:border-zinc-700'
                }`}
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="p-2 text-slate-400 hover:text-blue-300 hover:bg-slate-950 rounded transition-colors ml-4"
                ...
                {!isEditing ? (
                  <>
                    ...
                    <Button
                      ...
                      className="bg-slate-600 hover:bg-blue-700 text-white font-bold gap-2"
                    >
                      <TrendingUp size={16} />
                      Обновить статус
                    </Button>
                  ...
                  <div className="space-y-4 bg-zinc-800/30 border border-slate-500/30 rounded-lg p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent"
                        >
                          {statuses.map(status => (
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="bg-slate-600 hover:bg-blue-700 text-white font-bold"
                      >
                        Сохранить
                      </Button>
                      <Button
                    ...
                    {taskHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {taskHistory.map((change) => (
                          <div key={change.id} className="text-sm border-l-2 border-slate-500 pl-3 py-1">
                            ...
                            <p className="text-white">
                              <span className="text-slate-400">{getFieldNameRu(change.field_name)}</span>:{' '}
