...
export default function ${dept.name.charAt(0).toUpperCase() + dept.name.slice(1)}TimesheetPage() {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
           <h1 className="text-3xl font-bold flex items-center gap-2">
             <Calendar className="text-[#E60012]" /> Табель ${dept.title}
           </h1>
               ...
               {!loading && employees.length === 0 && (
                  <tr>
                     <td colSpan={35} className="p-12 text-center text-zinc-500">
                        В цехе ${dept.title.toLowerCase()} нет сотрудников.
                     </td>
                  </tr>
               )}
            </tbody>
